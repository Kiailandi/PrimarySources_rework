...
(function ($, mw ) {
  ...
  QUnit.test("ps_qualifierHtml", function( assert ){
    assert.equal(mw.PrimarySources.template.qualifierHtml, HTML_TEMPLATES.qualifierHtml, "Test PrimarySources qualifierHtml");
  });

  QUnit.test("ps_sourceHtml", function( assert ){
    assert.equal(mw.PrimarySources.template.sourceHtml, HTML_TEMPLATES.sourceHtml, "Test PrimarySources sourceHtml");
  });

  QUnit.test("ps_sourceItemHtml", function( assert ){
    assert.equal(mw.PrimarySources.template.sourceItemHtml, HTML_TEMPLATES.sourceItemHtml, "Test PrimarySources sourceItemHtml");
  });

  QUnit.test("ps_statementViewHtml", function( assert ){
    assert.equal(mw.PrimarySources.template.statementViewHtml, HTML_TEMPLATES.statementViewHtml, "Test PrimarySources statementViewHtml");    
  });

  QUnit.test("ps_mainHtml", function( assert ){
    assert.equal(mw.PrimarySources.template.mainHtml, HTML_TEMPLATES.mainHtml, "Test PrimarySources mainHtml");
  });
