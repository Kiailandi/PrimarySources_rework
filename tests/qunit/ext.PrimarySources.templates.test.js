					...
					'<span class="wikibase-toolbar-item wikibase-toolbar wikibase-edittoolbar-container wikibase-toolbar-container">' +
						'<span class="wikibase-toolbar-item wikibase-toolbar wikibase-toolbar-container">' +
							'<span class="wikibase-toolbarbutton wikibase-toolbar-item wikibase-toolbar-button wikibase-toolbar-button-add">' +
								'<a class="pst-button pst-source pst-approve" href="#" data-statement-id="{{statement-id}}" data-property="{{data-property}}" data-object="{{data-object}}" data-sources="{{data-source}}" data-qualifiers="{{data-qualifiers}}">' +
									'<span class="wb-icon">' +
									'</span>' +
									'approve reference' +
								'</a>' +
						...
						'<span class="wikibase-toolbar-item wikibase-toolbar wikibase-toolbar-container">' +
							'<span class="wikibase-toolbarbutton wikibase-toolbar-item wikibase-toolbar-button wikibase-toolbar-button-edit">' +
								'<a class="pst-button pst-source pst-edit" href="#" data-statement-id="{{statement-id}}" data-property="{{data-property}}" data-object="{{data-object}}" data-sources="{{data-source}}" data-qualifiers="{{data-qualifiers}}">' +
									'<span class="wb-icon">' +
									'</span>' +
									'edit reference' +
								'</a>' +
						...
						'<span class="wikibase-toolbar-item wikibase-toolbar wikibase-toolbar-container">' +
							'<span class="wikibase-toolbarbutton wikibase-toolbar-item wikibase-toolbar-button wikibase-toolbar-button-remove">' +
								'<a class="pst-button pst-source pst-reject" href="#" data-statement-id="{{statement-id}}" data-property="{{data-property}}" data-object="{{data-object}}" data-sources="{{data-source}}" data-qualifiers="{{data-qualifiers}}">' +
									'<span class="wb-icon">' +
									'</span>' +
										'reject reference' +
								'</a>' +
		...
		statementViewHtml:
			'<div class="wikibase-statementview wb-normal listview-item wikibase-toolbar-item new-object">' +
				...
				'<span class="wikibase-toolbar-container wikibase-edittoolbar-container">' +
					'<span class="wikibase-toolbar-item wikibase-toolbar wikibase-toolbar-container">' +
						'<span class="wikibase-toolbarbutton wikibase-toolbar-item wikibase-toolbar-button wikibase-toolbar-button-add">' +
							'<a class="pst-button pst-property pst-approve" href="#" data-statement-id="{{statement-id}}" data-property="{{data-property}}" data-object="{{data-object}}" data-sources="{{data-sources}}" data-qualifiers="{{data-qualifiers}}">' +
								'<span class="wb-icon">' +
								'</span>' +
								'approve claim' +
							'</a>' +
					...
					'<span class="wikibase-toolbar-item wikibase-toolbar wikibase-toolbar-container">' +
						'<span class="wikibase-toolbarbutton wikibase-toolbar-item wikibase-toolbar-button wikibase-toolbar-button-edit">' +
							'<a class="pst-button pst-property pst-edit" href="#" data-statement-id="{{statement-id}}" data-property="{{data-property}}" data-object="{{data-object}}" data-sources="{{data-sources}}" data-qualifiers="{{data-qualifiers}}">' +
								'<span class="wb-icon">' +
								'</span>' +
								'edit claim' +
							'</a>' +
					...
					'<span class="wikibase-toolbar-item wikibase-toolbar wikibase-toolbar-container">' +
						'<span class="wikibase-toolbarbutton wikibase-toolbar-item wikibase-toolbar-button wikibase-toolbar-button-remove">' +
							'<a class="pst-button pst-property pst-reject" href="#" data-statement-id="{{statement-id}}" data-property="{{data-property}}" data-object="{{data-object}}" data-sources="{{data-sources}}" data-qualifiers="{{data-qualifiers}}">' +
								'<span class="wb-icon">' +
								'</span>' +
								'reject claim' +
							'</a>' +
